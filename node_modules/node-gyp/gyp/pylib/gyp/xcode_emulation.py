...
class XcodeSettings(object):
  ...
  def Getprod-name(self):
    """Returns PRODUCT_NAME."""
    return self.spec.get('product_name', self.spec['target_name'])

  def GetFullprod-name(self):
  ...
  def GetWrapperName(self):
    ...
    assert self._IsBundle()
    return self.Getprod-name() + self.GetWrapperExtension()
  ...
  def GetInstallName(self):
    ...
    if '$' in install_name:
      ...
      if self._IsBundle():
        ...
        install_name = install_name.replace(
            '$(PRODUCT_NAME)', self.Getprod-name())
      else:
...
def _GetXcodeEnv(xcode_settings, built_products_dir, srcroot, configuration,
  ...
  env = {
    ...
    'PRODUCT_NAME' : xcode_settings.Getprod-name(),
  ...
  if spec['type'] in (
    ...
    env['FULL_PRODUCT_NAME'] = xcode_settings.GetFullprod-name()
