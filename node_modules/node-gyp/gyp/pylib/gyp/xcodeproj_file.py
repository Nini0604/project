...
class XCTarget(XCRemoteObject):
  ...
  # PBXContainerItemProxy.
  #
  # Setting a "name" property at instantiation may also affect "prod-name",
  ...
  def __init__(self, properties=None, id=None, parent=None,
    ...
    # property was supplied, set "prod-name" if it is not present.  Also set
    # the "PRODUCT_NAME" build setting in each configuration, but only if
    # the setting is not present in any build configuration.
    if 'name' in self._properties:
      if not 'prod-name' in self._properties:
        self.SetProperty('prod-name', self._properties['name'])

    if 'prod-name' in self._properties:
      if 'buildConfigurationList' in self._properties:
        configs = self._properties['buildConfigurationList']
        if configs.HasBuildSetting('PRODUCT_NAME') == 0:
          configs.SetBuildSetting('PRODUCT_NAME',
                                  self._properties['prod-name'])
...
class PBXNativeTarget(XCTarget):
  ...
  def __init__(self, properties=None, id=None, parent=None,
    ...
    if 'prod-name' in self._properties and \
      ...
      if products_group != None:
        ...
        if force_extension is not None:
          ...
          if filetype.startswith('compiled.mach-o.executable'):
            product_name = self._properties['prod-name']
            product_name += suffix
            suffix = ''
            self.SetProperty('prod-name', product_name)
